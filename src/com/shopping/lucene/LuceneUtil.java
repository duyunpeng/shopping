...
public class LuceneUtil {
	...
	public List<LuceneVo> searchIndex(String keyword, int start, int size, double begin_price, double end_price, Sort sort,String area_id) throws IOException {
	...
	public LuceneResult search(String params, int pageNo, double begin_price, double end_price, ScoreDoc after, Sort sort,String area_id) {
		...
		try {
			...
			if (intPageNo < 1)
				intPageNo = 1;
			List vo_list = searchIndex(params, (intPageNo - 1) * this.pageSize, this.pageSize, begin_price, end_price, sort,area_id);
	...
	public static void main(String[] args) {
		...
		Date d1 = new Date();
		LuceneResult list = lucence.search("专柜正品黑色时尚冬装男", 0, 0.0D, 500.0D, null, null,null);
		Date d2 = new Date();
